                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.thumb_up,color: AppColors.gray71,),
                                  SizedBox(width:25.w),
                                  Icon(CupertinoIcons.heart_fill,color: AppColors.gray71),
                                  SizedBox(width:25.w),
                                  Icon(PhosphorIcons.chatCircleDots(PhosphorIconsStyle.fill),color: AppColors.gray71),
                                  SizedBox(width:25.w),
                                  Container(
                  color: Colors.white,
                  child: Container(
