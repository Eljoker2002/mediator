...
class MyCV extends StatelessWidget {
   MyCV({super.key});
  UploadApiController controller =UploadApiController();
  @override
 ...
 void openFiles()async{
  FilePickerResult? resulttFile=await FilePicker.platform.pickFiles();
  if (resulttFile!=null) {
    PlatformFile file=resulttFile.files.first;
    print(file.name);
    print(file.bytes);
    print(file.extension);
    print(file.path);
  }  else{
    print("Sorry there is some thing wrong");
  }
 }
